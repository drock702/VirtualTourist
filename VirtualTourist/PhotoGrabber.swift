...
//                                self.flickrPhotoTitle.text = "\(self.getLatLonString()) \(photoTitle)"
//                            } else {
//                                self.flickrPhotoTitle.text = "\(self.getLatLonString()) (Untitled)"
//                            }
//                        } else {
//                            self.flickrPhotoTitle.text = photoTitle ?? "(Untitled)"
//                        }
//                    })
//                } else {
